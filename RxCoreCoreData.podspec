...
iOS project code-base inspired by modern architectures: Redux, RIBs
  ...
  s.module_name = 'RxCoreCoreData'
  s.swift_version = "5.0"
  s.prefix_header_file = false
  s.framework = 'CoreData'
  s.framework = 'Foundation'
  
  s.source_files = 'Sources/CoreData/**/*.{h,m,mm,swift,xcdatamodeld}'
  s.resources = 'Sources/CoreData/Model/MetaModel.xcdatamodeld'
  s.dependency 'RxCoreBase'
  s.dependency 'RxCoreRepository'
end
