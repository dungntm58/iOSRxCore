...
open class BaseCollectionViewSource: BaseListViewSource, LoadingAnimatableViewSource, BindableCollectionViewDataSource {
    ...
    private lazy var loadingCell: CellModel = { getLoadingCellModel() }()
    ...
    public func register(in collectionView: UICollectionView) {
        ...
        let differentiableDataSource = DifferentiableSectionedCollectionViewDataSource<DataSection>(configureCell: configureCell)
        collectionView.rx
